...
FEATURE_SECTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "label": "Ballroom",
        "tone": "pollen",
        "features": ["ballroom", "dump_sleep", "overnight_voice_report", "free_first_routing", "auto_graphify", "selective_recall", "venice_mcp_preset"],
    },
    {
        "id": "settings",
        "label": "Settings",
...
FEATURE_LABELS: dict[str, str] = {
    ...
    "content_pack_factory": "Content Pack Factory",
    ...
    "overnight_voice_report": "Voice overnight swarm report (Ballroom TTS)",
    ...
    "pattern_explorer": "Pattern Explorer — agentic design pattern dashboard",
    "episodic_memory": "Episodic memory — session timeline (Pattern 8)",
    "ai_harness_dashboard": "AI Layer harness dashboard (rules, skills, MCP)",
...
_FEATURE_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "overnight_voice_report": {"internal": True, "commercial": True, "min_tier": TIER_PRO},
    ...
    "episodic_memory": {"internal": True, "commercial": True, "min_tier": TIER_PRO},
