...
from app.core.cost_governor import BudgetExceededError
from app.domain.agents.factory import instantiate_agent
from app.core.config import get_settings
from app.core.logging import get_logger
from app.infrastructure.persistence.models.enums import StepStatus, TaskStatus, WorkflowStatus
...
from app.application.services.sub_swarm.plan import plan_execution_batches
from app.application.services.sub_swarm.selection import pick_agent_for_step
from app.application.services.sub_swarm.state import SubSwarmWorkflowState
from app.application.services.waggle_dance import broadcast_waggle_dance
...
async def execute_workflow_steps_on_swarm(
    ...
    hierarchy_hint = {
        "revision": "phase0.5",
        "max_parallel_specialists": int(cfg_local.swarm_max_concurrent_specialist_workers),
        "max_active_manager_templates": int(cfg_local.swarm_max_manager_templates_active),
        "tier": "sub_swarm_langgraph",
    }
    base_payload = {**(dict(state.get("payload") or {})), "hierarchy_hint": hierarchy_hint}
