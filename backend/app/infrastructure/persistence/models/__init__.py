...
_EXPORTABLE: dict[str, tuple[str, str]] = {
    ...
    "BrowserAutomationAction": ("app.infrastructure.persistence.models.browser_session", "BrowserAutomationAction"),
    ...
    "TenantFinetuneJobORM": (
        "app.infrastructure.persistence.models.tenant_finetune_job",
        "TenantFinetuneJobORM",
    ),
    ...
    "GrokRunORM": ("app.infrastructure.persistence.models.grok_control_plane", "GrokRunORM"),
    "GrokRunStepORM": ("app.infrastructure.persistence.models.grok_control_plane", "GrokRunStepORM"),
    "GrokRunEventORM": ("app.infrastructure.persistence.models.grok_control_plane", "GrokRunEventORM"),
    "GrokRunApprovalORM": ("app.infrastructure.persistence.models.grok_control_plane", "GrokRunApprovalORM"),
    "GrokRunArtifactORM": ("app.infrastructure.persistence.models.grok_control_plane", "GrokRunArtifactORM"),
    ...
    "TenantAuditLog": ("app.infrastructure.persistence.models.tenant", "TenantAuditLog"),
    "TenantInvite": ("app.infrastructure.persistence.models.tenant", "TenantInvite"),
    ...
    "PublicShareLink": ("app.infrastructure.persistence.models.public_share", "PublicShareLink"),
    "MemoryEvolutionProposal": (
        "app.infrastructure.persistence.models.memory_evolution",
        "MemoryEvolutionProposal",
    ),
    ...
    "SocialConnectedAccount": (
        "app.infrastructure.persistence.models.social_connected_account",
        "SocialConnectedAccount",
    ),
    ...
    "Tenant": ("app.infrastructure.persistence.models.tenant", "Tenant"),
    "TenantScopedMixin": ("app.infrastructure.persistence.models.base", "TenantScopedMixin"),
...
_MODEL_PACKAGES: tuple[str, ...] = (
    ...
    "app.infrastructure.persistence.models.browser_session",
    ...
    "app.infrastructure.persistence.models.public_share",
    "app.infrastructure.persistence.models.memory_evolution",
    "app.infrastructure.persistence.models.billing",
    ...
    "app.infrastructure.persistence.models.grok_control_plane",
