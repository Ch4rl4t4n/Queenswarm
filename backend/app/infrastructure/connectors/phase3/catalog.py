...
_PHASE3_RAW: tuple[Phase3ConnectorTemplate, ...] = (
    ...
    Phase3ConnectorTemplate(
        ...
        tools=(
            ...
            {
                "name": "repos_contents_put",
                "path": "/repos/{owner}/{repo}/contents/{path}",
                "method": "PUT",
                "description": "Create or update file on branch (Skill Factory export, Maintainer).",
                "required_permission": "tool:write",
            },
            {
                "name": "git_ref_get",
                ...
                "method": "GET",
                "description": "Resolve branch tip SHA — pass ref like heads/main.",
            },
            {
                "name": "git_ref_create",
                "path": "/repos/{owner}/{repo}/git/refs",
                "method": "POST",
                "description": "Create branch ref from SHA (Skill Factory export branches).",
                "required_permission": "tool:write",
            },
        ),
    ),
    Phase3ConnectorTemplate(
        template_id="gumroad_rest",
        category="billing",
        title="Gumroad REST",
        summary="Create draft digital products for Skill Factory LISTING.md exports.",
        documentation_url="https://gumroad.com/api",
        suggested_slug="gumroad_rest",
        auth_type="bearer_token",
        ...
        tools=(
            {
                ...
                "path": "/products",
                "method": "POST",
                "description": "Create draft product (Skill Factory Gumroad listing).",
                "required_permission": "tool:write",
            },
            {
                "name": "products_list",
