      ...
      await route.fulfill({
        ...
        body: JSON.stringify({
          ...
          skill_factory_harness_strip: {
            ...
            message: "No verified skills yet — Research → Queue → Library, then attach in Sessions.",
            ...
            queue_href: "/tasks#mission-factory-queue",
            library_href: "/apps-tools/skill-factory#skill-factory-library",
            agents_href: "/agents#sessions",
          ...
          links: {
            ...
            skill_factory_queue: "/tasks#mission-factory-queue",
