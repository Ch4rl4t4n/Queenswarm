...
export const PLANNED_PLATFORM_CAPABILITIES: PlannedCapability[] = [
  ...
  },
  {
    ...
    rationale: "✅ Shipped — BehavioralMemoryPanel at /settings/harness.",
    competitiveEdge: "Operator trains swarm without code — Slack optional P2.",
    targetPhase: "Settings",
  },
  {
    id: "layered-agents-md",
    name: "Layered AGENTS.md harness hierarchy",
    priority: "P1",
    impact: "medium",
    rolloutPhase: "phase6",
    week: 2,
    owner: "dev",
    auditGate: "docs/HARNESS_SELF_MAINTAINING_ANALYSIS.md",
    summary: "Root + backend + frontend AGENTS.md layers surfaced in harness snapshot.",
    rationale: "Anthropic Medin — harness > model; scoped rules per module.",
    competitiveEdge: "Visible layered harness vs single monolithic rules file.",
    hints: "AGENTS.md · backend/AGENTS.md · frontend/AGENTS.md",
    targetPhase: "Settings",
  },
  {
    id: "self-extending-tool-marketplace",
    name: "Self-extending tool marketplace flow",
    priority: "P2",
    impact: "high",
    rolloutPhase: "phase6",
    week: 4,
    owner: "dev",
    auditGate: "docs/HARNESS_SELF_MAINTAINING_ANALYSIS.md",
    summary: "Goal → propose MCP presets → simulate manifest → verified install.",
    rationale: "✅ Shipped — POST /tools/marketplace/propose|simulate|install in Unified Tool Hub.",
    competitiveEdge: "AnswerThis self-extending tools with Queenswarm simulation gate.",
    hints: "Integrations → Tool Hub · require_simulation on install",
    targetPhase: "Integrations",
  },
];
