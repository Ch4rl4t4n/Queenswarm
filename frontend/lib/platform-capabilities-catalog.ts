...
export const PLANNED_PLATFORM_CAPABILITIES: PlannedCapability[] = [
  ...
  },
  {
    ...
    summary: "Folder → Neo4j graph + Obsidian wiki + selective recall (40–70% token savings target).",
    rationale: "Post #1 Graphify — 70% už hotové; chýba UX hook + selective RAG.",
    competitiveEdge: "Project shape map + verified recall, nie statický folder dump.",
