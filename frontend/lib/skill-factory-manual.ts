...
export const SKILL_FACTORY_STEPS: SkillFactoryManualStep[] = [
  ...
  {
    id: "library-smart-rebuild",
    phase: 6,
    title: "6. Smart rebuild (rejected/draft)",
    summary: "Do not discard — inject prior failure learnings (critic APPROVE, 3+ steps) into a guided factory rebuild.",
    hint: "Retire niche only when market has no signal. Deprioritize lowers research score. Worth retry boosts next run.",
    actions: [
      "Library tab → Smart rebuild on rejected skill",
      "Queue tab — watch new session",
      "Approve forge only when critic APPROVE + quality pass",
    ],
  ...
  },
  {
    id: "library-export",
    phase: 7,
    title: "7. Export harness pack",
    summary: "Download v2 bundle: SKILL.md + HARNESS.md + EVAL_REPORT.md + LISTING.md + TOOLS.json + MCP_SETUP.md.",
  ...
  },
  {
    id: "external-sales",
    phase: 9,
    title: "9. Sell outside the app (optional)",
