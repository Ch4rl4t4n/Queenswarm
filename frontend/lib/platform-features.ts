...
export const PLATFORM_FEATURE_CATALOG: Record<string, FeatureSpec> = {
  ...
  overnight_voice_report: { internal: true, commercial: true, minTier: "pro" },
  ...
  self_extending_tool_marketplace: { internal: true, commercial: true, minTier: "pro" },
...
export const ROUTE_FEATURE_KEYS: Record<string, string> = {
  ...
  "/apps-tools/skill-factory": "skill_factory",
  "/knowledge": "knowledge",
