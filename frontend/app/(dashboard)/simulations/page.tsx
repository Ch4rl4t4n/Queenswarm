      ...
      <div className="grid gap-4 md:grid-cols-2">
        {audits.map((audit) => (
          <article key={audit.id} className="rounded-3xl border border-success/35 bg-black/35 p-5 shadow-[0_0_42px_rgba(0,255,136,0.18)]">
            ...
            <p className="mt-4 font-[family-name:var(--font-jetbrains-mono)] text-sm text-muted-foreground">
              confidence {audit.confidence_pct ?? 0}%
            </p>
            <p className="mt-4 font-[family-name:var(--font-jetbrains-mono)] text-xs text-muted-foreground">
