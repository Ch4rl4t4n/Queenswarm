...
export function AgentSessionPlaybookDialog({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg rounded-2xl border border-[color:var(--qs-border-2)] bg-[#070d16] p-5 shadow-[0_0_40px_rgba(255,184,0,0.08)]"
        style={{ borderRadius: "var(--qs-radius-lg)" }}
        onClick={(event) => event.stopPropagation()}
        role="dialog"
        aria-labelledby="session-playbook-title"
      >
