...
| `analytics-workspace-panel` | `analytics_workspace` | Apps & Tools | `apps.analytics.decision_report.v1` | **Track L DA3** ✅ — see [`BUSINESS_DATA_ANALYTICS_OS.md`](BUSINESS_DATA_ANALYTICS_OS.md) |
